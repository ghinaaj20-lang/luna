...
import uuid
from .models import Content, Like, Comment, CosmicEvent
...
from .forms import UserProfileForm  # If you have a form
...
class UserProfileView(APIView):
    ...
    def get(self, request):
        user = request.user
        contents = Content.objects.filter(author=user).order_by('-created_at')
        ...
        contents_data = ContentSerializer(contents, many=True, context={'request': request}).data
